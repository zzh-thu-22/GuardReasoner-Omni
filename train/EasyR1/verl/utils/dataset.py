...
def process_video(
    video: str, min_pixels: Optional[int], max_pixels: Optional[int], video_fps: float, max_frames: int = 128, return_fps: bool = False
    ...
    return fetch_video(vision_info, return_video_sample_fps=return_fps,  return_video_metadata=return_fps)
...
class RLHFDataset(Dataset):
    ...
    def _build_messages(self, example: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        msg = []
        msg.append({"role": "system", "content": INSTRUCTION})
        ...
        if self.image_key in example and len(example[self.image_key]) > 0:
            ...
            msg.append({"role": "user", "content": content_list})
            ...
            msg.append({"role": "user", "content": prompt_str})
            return msg
    ...
    def _filter_overlong_prompts(self, example: dict[str, Any]) -> bool:
        ...
        if self.image_key in example and len(example[self.image_key]) > 0:
            ...
            model_inputs = self.processor(
                videos=processed_videos, text=[prompt], add_special_tokens=False, return_tensors="pt", video_metadata=video_metadatas, **video_kwargs
            )
    ...
    def __getitem__(self, index):
        ...
        example["multi_modal_data"] = {"videos": [], "images": []}
