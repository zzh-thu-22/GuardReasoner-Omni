                    ...
                    if len(images) != 0:
                        ...
                        multi_modal_inputs = dict(
                            self.processor.video_processor(
                                videos=videos,
                                video_metadata=video_metadatas if len(video_metadatas) != 0 else None,
                                return_tensors="pt",
                                **video_kwargs,
                            )
                        )
